...
$file_name = str_replace(' ', '', $files['pdf']['name']);
  $file_tmp = $files['pdf']['tmp_name'];
 /* GUARDAMOS LA IMG TEMPORALMENTE */

move_uploaded_file($file_tmp, $_SERVER['DOCUMENT_ROOT'] . getFolderProject() . '/pdf/' . $file_name); /* INDICAMOS LA RUTA DONDE SE VA ALMACENAR ESA IMAGEN */
